...
def generate_launch_description():
    ...
    first_launch_file = launch.substitutions.LaunchConfiguration('launch_sim', default='/home/sreeja/dev_ws/src/my_bot/launch/launch_sim.launch.py')
    first_launch = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={'world': './src/my_bot/worlds/home.world'}.items()
    )
    ...
    # second_launch_file = launch.substitutions.LaunchConfiguration('finial', default='/home/sreeja/dev_ws/src/my_bot/launch/finial.launch.py')
